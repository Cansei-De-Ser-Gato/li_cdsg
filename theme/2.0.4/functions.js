...
theme.pages['pagina-produto'] = function(){
    ...
    $(document).ajaxComplete(function(e, data, opt) {
        if (opt.url.includes('compre_junto')) {
            $('.compre-junto .compre-junto__conteudo').before('<div class="compre_junto-cover d-none d-md-block"><img src="https://via.placeholder.com/873x752"/></div>')
